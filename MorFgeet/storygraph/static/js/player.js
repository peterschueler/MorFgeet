...
function handleAudioPlayback(i, time) {
	...
	if (seeking) {
		...
		audio[i].play();
		playButton[i].innerHTML = "<svg width=\'20px\' height=\'20px\' viewBox=\'0 0 4267 4267\'><g id=\'Layer1\'><g transform=\'matrix(1.35841,0,0,1,127.132,-10.9882)\'><rect x=\'519.872\' y=\'192.448\' width=\'613.461\' height=\'3899.22\' /></g><g transform=\'matrix(1.35841,0,0,1,1793.8,-10.9882)\'><rect x=\'519.872\' y=\'192.448\' width=\'613.461\' height=\'3899.22\' /></g></g></svg>";
	} else {
		audio[i].pause();
		playButton[i].innerHTML = "<svg width=\'20px\' height=\'20px\' viewBox=\'0 0 4267 4267\'><g transform=\'matrix(-0.000548567,1.15446,-0.84241,-0.000400289,3881.96,-576.737)\'><path d=\'M2348.86,168.164L4039.58,3979.17L658.134,3979.17L2348.86,168.164Z\' /></g></svg>";
	}
}
